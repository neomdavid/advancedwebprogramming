  ...
  return (
    <div className="user-management">
      <div className="page-header">
        ...
        <button className="add-user-btn" onClick={() => { setShowModal(true); setEditingArticle(null); setFormData(initialForm); }}>
              ...
              <tr key={article._id}>
                ...
                <td>
                  <div className="action-buttons">
                    <button className="edit-btn" onClick={() => handleEditArticle(article)}><EditIcon /></button>
                    <button className="delete-btn" onClick={() => { setArticleToDelete(article); setShowDeleteModal(true); }}><DeleteIcon /></button>
                  </div>
                </td>
              </tr>
            ))}
          ...
          <div className="modal-content">
            ...
            <form onSubmit={editingArticle ? handleUpdateArticle : handleAddArticle}>
              ...
              <div className="modal-buttons">
                <button type="submit" className="save-btn">{editingArticle ? 'Save Changes' : 'Add'}</button>
                <button type="button" className="cancel-btn" onClick={() => { setShowModal(false); setEditingArticle(null); setFormData(initialForm); }}>Cancel</button>
              </div>
            </form>
          </div>
        </div>
